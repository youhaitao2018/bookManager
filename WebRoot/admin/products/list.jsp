...
<script type="text/javascript">
	...
	//提示用户是否删除
	function delBook(isbn,name){
		if(confirm("是否确定删除:"+name+"?")){
			location.href="${pageContext.request.contextPath }/DeleteBookServlet?isbn="+isbn;
		}
	}
			...
			<c:forEach items="${books }" var="b">							
								<tr onmouseover="this.style.backgroundColor = 'white'"
									...
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
										width="23"><input type="checkbox" name="ids" value="${b.isbn }"/></td>
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
										width="23">${b.isbn }</td>
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
										width="18%">${b.name }</td>
									...
									<td align="center" style="HEIGHT: 22px" width="7%"><a
										href="${pageContext.request.contextPath}/findBookByIdServlet?isbn=${b.isbn }">
											<img
									...
									<td align="center" style="HEIGHT: 22px" width="7%"><a
										href="javascript:delBook('${b.isbn }','${b.name }')">
											<img
